...
o	Player Details Table: Contains information about the players, their IDs, and login details.
o	Level Details Table: Includes data on game levels, stages, difficulty levels, and player performance.
...
1.	Data Import: Import the data as a flat file into the gaming analysis database.
...
o	Players can only progress to Level 1 (L1) and Level 2 (L2) with system-generated codes.
